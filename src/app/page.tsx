...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-[#FDF6F0]">
      {/* GitHub Link */}
      <a
        href="https://github.com/mmednik-noves/txshare"
        target="_blank"
        rel="noopener noreferrer"
        className="absolute top-4 right-4 z-20 text-gray-900 hover:text-green-500 transition-colors"
      >
        <svg
          className="w-8 h-8"
          fill="currentColor"
      ...
      <footer className="mt-8 text-black text-sm z-10">
        ...
        with 💚 and{' '}
        <a
          href="https://docs.noves.fi/reference/api-overview?utm_source=demo&utm_medium=devrel&utm_campaign=txshare"
          target="_blank"
          rel="noopener noreferrer"
          className="text-gray-900 hover:text-green-500 transition-colors font-semibold"
        >
